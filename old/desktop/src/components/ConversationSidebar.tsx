  ...
  return (
    <aside className="conv-sidebar flex flex-col bg-surface border-r border-border shrink-0">
      ...
      <div className="px-3 py-3 border-b border-border space-y-2">
        <div className="grid grid-cols-2 gap-1 bg-base border border-border rounded-lg p-1">
          <button
            onClick={() => setView("chat")}
            className={`inline-flex items-center justify-center gap-1.5 px-2 py-1.5 rounded text-xs transition-colors ${
              view === "chat" ? "bg-accent/15 text-accent" : "text-muted hover:text-primary"
            }`}
          >
          ...
          <button
            ...
            className={`inline-flex items-center justify-center gap-1.5 px-2 py-1.5 rounded text-xs transition-colors ${
              view === "agents" ? "bg-accent/15 text-accent" : "text-muted hover:text-primary"
            }`}
          >
            <Bot size={13} />
            Agentes
